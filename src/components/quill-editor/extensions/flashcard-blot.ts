...
// const withDisabledMarkdown = (quill: any, callback: () => void) => { // Added : any type
...
//   create(value: { cards?: { front: string; back: string }[]; currentIndex?: number; isFlipped?: boolean } = {}, quillInstance?: any) { // Added : any type
